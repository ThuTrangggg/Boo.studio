...
<head>
    <title>Boo  | Lịch sử mua hàng</title>
<!-- 
    ...
    <div class="row">    
        ...
        <div class="col-sm-8" >           
            <table class="table table-striped" style="margin-bottom: 50px;">
                ...
                ;?>
                <tr>
                    <td colspan="6" style="padding: 11px;color: #ad9393; font-size: 20px; text-align: center;">Không có lịch sử mua hàng</td>
                </tr>
                <?php
                };?>
                </table>
                <a class="btn btn-lg btn-block btn-signin text-uppercase text-white" href="../index.php" style="text-align: center;width: 100%;color: #333;">Mua thêm</a>
                </div>
<hr><br><br><br>
    </div>          
</div>
