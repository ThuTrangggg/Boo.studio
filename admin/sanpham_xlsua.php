<?php 
   ...
   // $luu_file_anh_tam=$_FILES["txtanh"]["tmp_name"];
    ...
    {
        $sql = "
        UPDATE `tbl_sanpham` SET `loaisanpham_id` = '".$loaisanpham_id."', `ten_sanpham` = '".$ten_sanpham."', `gia`='".$gia."', `gia_ban_khuyen_mai`='".$gia_ban_khuyen_mai."', `so_luong`='".$so_luong."', `mo_ta` = '".$mo_ta."' WHERE `tbl_sanpham`.`sanpham_id` = '".$sanpham_id."'
        ";
    }
    else
    {
        $sql = "
        UPDATE `tbl_sanpham` SET `loaisanpham_id` = '".$loaisanpham_id."', `ten_sanpham` = '".$ten_sanpham."', `anh` = '".$anh."', `gia`='".$gia."', `gia_ban_khuyen_mai`='".$gia_ban_khuyen_mai."',`so_luong`='".$so_luong."', `mo_ta` = '".$mo_ta."' WHERE `tbl_sanpham`.`sanpham_id` = '".$sanpham_id."'
        ";
    }
