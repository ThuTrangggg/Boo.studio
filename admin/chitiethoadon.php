                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php 
                                        $hoadon_id=$_GET['id'];
                                        $sql1 = "
                                                  SELECT tbl_giohang.giohang_id,tbl_sanpham.ten_sanpham, tbl_sanpham.gia, tbl_sanpham.gia_ban_khuyen_mai,tbl_giohang.so_luong, tbl_sanpham.gia*tbl_giohang.so_luong FROM tbl_sanpham INNER JOIN tbl_giohang ON tbl_sanpham.sanpham_id=tbl_giohang.sanpham_id WHERE tbl_giohang.hoadon_id='".$hoadon_id."'
                                        ";
