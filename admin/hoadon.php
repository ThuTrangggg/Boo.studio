                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php 
                                        ...
                                        $sql = "
                                                  SELECT * FROM tbl_hoadon Left JOIN tbl_khachhang on tbl_hoadon.khachhang_id=tbl_khachhang.khachhang_id
                                        ";
                                    ...
                                    ;?>
                                        <tr>
                                            ...
                                            <?php
                                                $sql1 = "
                                                  SELECT SUM(tbl_sanpham.gia*tbl_giohang.so_luong), SUM(tbl_giohang.so_luong) 
                                                  FROM tbl_sanpham  INNER JOIN tbl_giohang ON tbl_sanpham.sanpham_id=tbl_giohang.sanpham_id 
                                                  WHERE tbl_giohang.hoadon_id='".$row["hoadon_id"]."'";
