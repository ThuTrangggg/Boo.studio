...
<html lang="en">
    <head>
        ...
        <title>Boo shop | Admin | Thêm mới sản phẩm</title>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="xlthemmoisanpham.php<?php if(isset($_GET['loaisanphamid'])) echo"?id=$loaisanphamid";?>" enctype="multipart/form-data" id="form" onsubmit="return validateForm()">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtHinhanh"  placeholder="Hình ảnh" name="txtHinhanh" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtMota" placeholder="Ghi chú" name="txtMota"> </input>
