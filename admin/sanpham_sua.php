...
<html lang="en">
    <head>
        ...
        <title>Boo shop | Admin | Cập nhật sản phẩm</title>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="sanpham_xlsua.php<?php if(isset($_GET['loaisanphamid'])) echo"?id=$loaisanphamid";?>" enctype="multipart/form-data" id="formsua" onsubmit="return validateForm()">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtanh"  placeholder="Ảnh" name="txtanh" value="<?php echo $row1["anh"] ;?>" />
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                                        <input class="form-control" id="txtgiabankhuyenmai" placeholder="Giá bán khuyến mãi" name="txtgiabankhuyenmai" value="<?php echo $row1["gia_ban_khuyen_mai"] ;?>"> </input>
                                                        <label for="txtgiabankhuyenmai">Giá khuyến mãi</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="txtmota" placeholder="Mô tả" name="txtmota" value="<?php echo $row1["mo_ta"] ;?>"> </input>
