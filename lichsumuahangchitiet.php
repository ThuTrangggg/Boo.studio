...
if (isset($_SESSION['login'])) {
    ...
    <head>
        <title>Boo| CHI TIẾT LỊCH SỬ MUA HÀNG</title>
                ...
                <div class="col-sm-8">
                    ...
                    ";
                        ...
                        while ($row = mysqli_fetch_array($ket_qua)) {
                            $i++;; ?>
                            <form method="post" action="/Nhom14/danh_gia/danh_gia.php">
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $row["giohang_id"]; ?></td>
                                    <?php
                                    $sql1 = "SELECT * from tbl_sanpham where sanpham_id =" . $hoadon_id;
                    ...
                    ";
                                    ...
                                    <td>
                                        <a href="/Nhom14/danh_sach_mat_hang/chi_tiet_mat_hang.php?id=<?php echo $r["sanpham_id"]; ?>"><?php echo $row["ten_sanpham"]; ?></a>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="sanpham_id" value="<?= $r['sanpham_id'] ?>">
